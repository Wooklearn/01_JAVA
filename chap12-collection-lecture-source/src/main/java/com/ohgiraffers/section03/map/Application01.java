...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* title. Map 의 자료구조에 대해 이해하고 HsshMap 을 이용할 수 있다. */
        ...
        *  */
        ...
        /* index. 2. 키는 중복저장이 안된다. (set 방식) */
        // 키는 중복저장이 되지 않기 때문에 가장 최신의 키로 덮어 쓰여진다.
        ...
        Set<String> KeySet = hmap2.keySet(); //hmap2.keySet <==  set 방식으로 바뀜
