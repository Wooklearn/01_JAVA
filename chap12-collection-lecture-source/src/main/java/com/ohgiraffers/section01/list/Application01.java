...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* comment.
        *   Collettion 3가지의 인터페이스 중 한 가지를 상속박아 구현
        *   1. List 인터페이스
        *   2. Set 인터페이스
        *   3. Map 인터페이스
        *  */
        ...
        /* comment. (중요)
        *   1. List 인터페이스
        *   - (중요)순서가 있는 데이터 집합으로 데이터 중복 저장 허용
...
//        List list = new list();
        ...
        *   레퍼런스 타입은 List 로 하는 것이 더 유연한 코드를 작성하는 방법이다. */
        ...
        alist.add(45.67);   // int, double 이러한 기본(원시)값을 객체 -> Integer, Double로 바꿔줌
        alist.add(new Date());
        ...
        *   지정한 타입 외에는 사용할 수 없게 된다. */
        ...
        // 즉 지정한 값 이외의 값을 넣으면 컴파일 오류가 발생하는걸 알 수 있음
//        stringsList.add(123);
