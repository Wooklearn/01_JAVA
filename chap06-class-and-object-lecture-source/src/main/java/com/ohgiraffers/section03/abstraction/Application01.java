...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   객체지향 프로그래밍
        *   현실세계의 모든 사건(event)는 객체와 객체간의 상호작용
        *   현실세계와 조금 다른 점은 객체각의 상호작용을 한다는 사실은 현실과
        ...
        *   우리는 너무 많은 정보를 가지고 있다. ex) 키, 몸무게, 주소 등등등
