...
public class Application {
    public static void main(String[] args) {
        ...
        *     결합도가 높다는것 = 한 곳을 수정하면 수정해야될 곳이 많은것
        *   - 동시성 문제를 고려해야 하기 때문에 난이도가 있다.
        *     에어컨 리모컨 예를들어서 내가 23도 하면 다른사람도 23도!
        *  */
...
//        EagerSingleton eagerSingleton = new EagerSingleton();
        ...
        System.out.println("eger1 의 hashcode() : " + eager1.hashCode());
        System.out.println("eger2 의 hashcode() : " + eager2.hashCode());
