...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        *   그래서 만약에 ++num1 동작을 했다면, result 를 출력했을 때
        *   11이 나와야 하지만, 결과가 10이 나온 것을 보아하니
        *   뒤 코드가 동작하지 않을 것을 출력을 통해 확인을 해보았다.
        *  */
        ...
        /* comment.
        *   && 의 조건식 두개가 모두 만족을 해야 true 를 반환을 하는데
        ...
        *  */
        ...
        /* index. 2. 논리 || 논리 : 앞의 결과가 true 이면 뒤를 실행 안함. */
        int num2 = 10;
