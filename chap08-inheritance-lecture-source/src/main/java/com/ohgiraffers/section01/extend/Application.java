...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   물려받은 멤버를 확장하거나, 추가적인 멤버를 작성하는 것도
        *   가능하다.
        ...
        *    2. 또한 부모 클래스의 변경이 쉽지 않다. 자식 클래스에서 중요하게 사용하고 있는
...
//        fireCar.isRunning();
        ...
        *   상속은 물려받는 것 뿐만 아니라 확장도 할 수 있다. */
        ...
        //Car도 스프레이 워터 기능을 쓸 수 있을까? ㄴㄴ 못쓴다.. 부모는 자식의 기능을 쓸 수 없다.
