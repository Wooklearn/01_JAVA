...
//        그 외에 본인이 만들고 싶은 예외사항 있으면 얼마든지 추가 가능
        ...
        Calculrator result = new Calculrator();
        ...
        switch (sign) {
            case '+':
                ...
                break;
            case '-':
                result.calculate2(first,second);
                break;
            case '*':
                result.calculate3(first,second);
                break;
            case '/':
                result.calculate4(first,second);
                break;
            case '%':
                result.calculate5(first,second);
                break;
        }
    }
}
