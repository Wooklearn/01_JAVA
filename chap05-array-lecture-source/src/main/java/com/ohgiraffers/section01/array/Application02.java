...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *  */                      //래퍼런스 변수 = 주소를 담는 변수
        ...
        /* comment.
        *   heap 메모리는 이름으로 접근하는 것이 아닌 주소로 접근을 하는것이다.
        ...
        *   로 바꾸어주는 메소드! 동일객체인 지 비교할 때 주로 쓰인다.  ex)주민번호 - 고유한값임
        *  */
        ...
        *  */
        ...
        System.out.println("iarr2 의 길이 : " + carr2.length);
        ...
        System.out.println("darr 의 해시코드 : " + darr.hashCode());
        ...
        *   배열의 사이즈를 6 에서 10 으로 쪼개는게 아닌
        *   새로운 공간을 할당해서 주소값을 래퍼런스변수에 덮어 쓴 것이다.
        *  */

        darr = new double[10];  //new 라는 걸 만날 때마다 주소를 새롭게 만들어준다.
        System.out.println("수정 후 darr의 해시코드 : " + darr.hashCode());
        ...
        *   heap 의 old 영역으로 이동하게 되어 GC(가비지 컬렉터)가
        *   삭제를 해준다.
        *  */
