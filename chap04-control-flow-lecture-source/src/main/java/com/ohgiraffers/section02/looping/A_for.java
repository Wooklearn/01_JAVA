...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        // index. 문제1. 1부터 10까지 1 씩 증가시키면서 i 값을 출력하는 반복문
        // 초기식 : int i = 1;
        // 조건식 : i <= 10;
        // 증감식 : i++;
    ...
    public void testForExample1() {
        /* title. 무엇을 반복하는지를 확인해서 반복문의로 개선할 수 있다.  */
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            System.out.println(i + "번째 학생의 성적을 입력해 주세요 : ");
            String gread = sc.nextLine();
            System.out.println(i + "번째 학생의 이름은" + student + "성적은" + gread + "입니다.");
        }
    }
...
//        int a = rd.nextInt(6) + 5;
    ...
    public void testForExample4() {
        /* comment.
        *   숫자 2개를 입력받아 작은 수에서 큰 수까지의 합을 구하시오
